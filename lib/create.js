...
function setupObjects(id, obj) {
    ...
    const logname = obj[adapter.namespace].logname;
    ...
    if (obj[adapter.namespace].avg === 'true' ||
        obj[adapter.namespace].avg === true ||
        obj[adapter.namespace].avg === 1
    ) {
    ...
    if ((obj[adapter.namespace].fivemin === 'true' && obj[adapter.namespace].count === 'true') ||
        (obj[adapter.namespace].fivemin === true && obj[adapter.namespace].count === true) ||
        (obj[adapter.namespace].fivemin === 1 && obj[adapter.namespace].count === 1)
    ) {
    ...
    if ((obj[adapter.namespace].sumcnt === 'true' && obj[adapter.namespace].count === 'true') ||
        (obj[adapter.namespace].sumcnt === true && obj[adapter.namespace].count === true) ||
        (obj[adapter.namespace].sumcnt === 1 && obj[adapter.namespace].count === 1)
    ) {
    ...
    if ((obj[adapter.namespace].sumgroup === 'true' && obj[adapter.namespace].sumdelta === 'true') ||
        (obj[adapter.namespace].sumgroup === true && obj[adapter.namespace].sumdelta === true) ||
        (obj[adapter.namespace].sumgroup === 1 && obj[adapter.namespace].sumdelta === 1)
    ) {
