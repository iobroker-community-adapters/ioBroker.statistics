module.exports = {
    ...
    '15MinSum': {
        common: {
            ...
            role: 'value',
            name: {
                en: 'Sum of 15 minute values',
                de: 'Summe von 15 Minuten',
                ru: 'Сумма 15 минутных значений',
                pt: 'Soma de 15 valores minuto',
                nl: 'Vertaling:',
                fr: 'Sum of 15 minute values',
                it: 'Somma di valori di 15 minuti',
                es: 'Suma de valores de 15 minutos',
                pl: 'Suma 15 minut',
                uk: 'Сума значень за 15 хвилин',
                'zh-cn': '第15分钟值'
            },
            write: false,
            read: true
    ...
    'hourSum': {
        common: {
            ...
            role: 'value',
            name: {
                en: 'Sum of hourly values',
                de: 'Summe der Stundenwerte',
                ru: 'Сумма почасовых значений',
                pt: 'Soma de valores de hora em hora',
                nl: 'Sum van uurlijkse waarden',
                fr: 'Sum of hourly values',
                it: 'Somma di valori orali',
                es: 'Suma de valores por hora',
                pl: 'Suma godzin',
                uk: 'Сума годинних значень',
                'zh-cn': '小时值'
            },
            write: false,
            read: true
    ...
    'weekSum': {
        common: {
            ...
            role: 'value',
            name: {
                en: 'Sum of weekly values',
                de: 'Summe der wöchentlichen Werte',
                ru: 'Сумма еженедельных ценностей',
                pt: 'Soma de valores semanais',
                nl: 'Sum of wekelijkse waarden',
                fr: 'Somme des valeurs hebdomadaires',
                it: 'Somma dei valori settimanali',
                es: 'Suma de valores semanales',
                pl: 'Cotygodniowe wartości',
                uk: 'Сума тижневих значень',
                'zh-cn': 'B. 每周价值的概述'
            },
            write: false,
            read: true
    ...
    'monthSum': {
        common: {
            ...
            role: 'value',
            name: {
                en: 'Sum of monthly values',
                de: 'Summe der monatlichen Werte',
                ru: 'Сумма ежемесячных ценностей',
                pt: 'Soma de valores mensais',
                nl: 'Sum van maandelijkse waarden',
                fr: 'Somme des valeurs mensuelles',
                it: 'Somma dei valori mensili',
                es: 'Suma de valores mensuales',
                pl: 'Suma miesięcznych wartości',
                uk: 'Сума місячних значень',
                'zh-cn': 'B. 每月价值的细目'
            },
            write: false,
            read: true
    ...
    'quarterSum': {
        common: {
            ...
            role: 'value',
            name: {
                en: 'Sum of quarterly values',
                de: 'Summe der vierteljährlichen Werte',
                ru: 'Сумма ежеквартальных ценностей',
                pt: 'Soma de valores trimestrais',
                nl: 'Vertaling:',
                fr: 'Somme des valeurs trimestrielles',
                it: 'Somma di valori trimestrali',
                es: 'Suma de valores trimestrales',
                pl: 'Ćwierć wartości',
                uk: 'Сума квартальних значень',
                'zh-cn': '季度值'
            },
            write: false,
            read: true
    ...
    'yearSum': {
        common: {
            ...
            role: 'value',
            name: {
                en: 'Sum of yearly values',
                de: 'Summe der jährlichen Werte',
                ru: 'Сумма ежегодных ценностей',
                pt: 'Soma de valores anuais',
                nl: 'Sum of jaarlijkse waarden',
                fr: 'Somme des valeurs annuelles',
                it: 'Somma di valori annui',
                es: 'Suma de valores anuales',
                pl: 'Suma rocznych wartości',
                uk: 'Сума річних значень',
                'zh-cn': '年值'
            },
            write: false,
            read: true
