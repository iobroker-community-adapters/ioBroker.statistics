...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new statistics name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/statistics.png')) {
            fs.renameSync(__dirname + '/admin/statistics.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/statistics.html')) {
            fs.renameSync(__dirname + '/widgets/statistics.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/statistics/js/statistics.js')) {
            fs.renameSync(__dirname + '/widgets/statistics/js/statistics.js', __dirname + '/widgets/statistics/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/statistics')) {
            fs.renameSync(__dirname + '/widgets/statistics',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Statistics/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Statistics'
                        },
                        {
